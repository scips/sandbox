...
def test():
    ...
    ctext = "58b1ffb4210a580f748b4ac714c001bd4a61044426fb515dad3f21f18aa577c0bdf302936266926ff37dbf7035d5eeb4"

    decrypted = padbuster.decrypt(ctext.decode('hex'), block_size=AES.block_size, iv=iv.decode('hex'))
