# Maths - Equation générale du second degré

## Démonstration de la formule de recherche de racine
...
|--|--|
| $\Delta\gt0$ | Il existe deux racines $\in \mathbb{R}$ |
| $\Delta=0$ | Il existe une racine $\in\mathbb{R}$ |
| $\Delta\lt0$ | Il n'existe aucune racines $\in\mathbb{R}$ |
